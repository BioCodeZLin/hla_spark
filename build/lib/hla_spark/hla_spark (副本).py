...
from scripts import filter_by_alignment_score as filter_al, best_match_ref_construction as best_m, genomic_coordinate_transformation as coord_stand
...
def VCFConversion_module(gene):
    ...
    #print(mpileup, hla_matrix, mut_hg38, chrom, sample)
...
if __name__ == '__main__':
    #arguments = argument_parser()
    #run_hla_spark(**arguments)
    os.chdir('/home/bios/pastfiles/bj_hos/23-method-hla/revised/codes/bam/')
    run_hla_spark('NA18747','NA18747_combined_R1.fastq.gz','NA18747_combined_R2.fastq.gz',n_core=10,step_list='6',hla_genes='DRB1')
